...
> 译者注：IntelX86架构的比较指令(cmp)通常与条件跳转语句配合使用。参考链接：[关于这段代码为何能够防止出现分支指令的讨论](http://stackoverflow.com/questions/25623721/why-does-this-method-of-computing-the-sign-of-an-integer-avoids-branching-on-cpu)）
