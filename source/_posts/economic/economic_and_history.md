...
真实世界是由一个个大大小小的[复杂系统](https://en.wikipedia.org/wiki/Complex_system)组成，这些复杂系统如“[混沌](https://baike.baidu.com/item/混沌学/1025452)”一样变化无常，面对复杂的真实世界，20世纪下半叶发展出了以控制论、系统论、信息论、运筹学、非线性科学等为基础的[系统科学](https://en.wikipedia.org/wiki/Systems_science)。比如基于AI深度学习通过捕捉复杂非线性关系，从而进行量化交易的私募基金就是用系统工程思维理解金融市场，2025年开年火爆的DeepSeek创始人梁文峰之前做的“幻方量化”就是其中之一。
