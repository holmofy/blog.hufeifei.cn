...
这类问题在国家实行营业税与增值税并存的时期（2016年全面“营改增”之前）更为突出。当时，纳税人的一项业务可能同时涉及缴纳增值税的货物销售和缴纳营业税的服务提供，带来了复杂的核算和遵从问题。即使在现行增值税制度下，一些大型集团仍可以通过内部交易定价、业务分拆等方式，将利润从高税率环节向低税率环节转移，实现集团整体税负的优化。
