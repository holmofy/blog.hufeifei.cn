...
$$
\begin{align}
基期增量_A&=\frac{现期_A}{1+增长率_a}\times增长率_a \\\\
基期增量_B&=\frac{现期_B}{1+增长率_b}\times增长率_b \\\\
\frac{基期增量_A}{基期增量_B}&=\frac{\frac{现期_A\times增长率_a}{1+增长率_a}}{\frac{现期_B\times增长率_b}{1+增长率_b}} \\\\
&=\frac{现期_A\times增长率_a\times(1+增长率_b)}{现期_B\times增长率_b\times(1+增长率_a)}
\end{align}
$$
