...
golang虽然丢掉了Java虚拟机，但是仍然是使用标记清除算法的GC语言，仍然会出现内存脆片的问题，本质上和Java换汤不换药。

Rust直接对标C/C++等系统编程语言，并在语法层面吸取了C/C++、Java、Javascript、Python、Ruby等语言的优点，同时没有C++的历史包袱，轻装上阵，是这些新兴语言中唯一有实力与C/C++竞争的语言，有必要好好学一下，这篇文章先简单入个门。
