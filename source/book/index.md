...
#book-collects{margin-top:20px} .book-collect{margin: 0 4px;}</style>
...
<div id="computer-science" class="books" style="display:block">
    ...
    <div class="doulist-item">
        <div class="mod">
            ...
            <div class="bd doulist-subject">
                <div class="source">
                    <a href="https://book.douban.com/subject/35934902/">来自：豆瓣读书</a>
                </div>
                <div class="post">
                        <img rel="external noreferrer nofollow noopener" referrerpolicy="no-referrer"
                            src="https://img2.doubanio.com/view/subject/l/public/s34245991.jpg">
                </div>
                <div class="title">
                    性能之巅（第2版）
                </div>
